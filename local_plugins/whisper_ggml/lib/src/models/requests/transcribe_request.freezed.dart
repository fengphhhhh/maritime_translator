...
/// previous version.
 bool get keepModelLoaded;/// Run inference on the GPU, via `whisper_context_params.use_gpu`.
///
...
@override
int get hashCode => Object.hashAll([runtimeType,audio,isTranslate,threads,isVerbose,language,isSpecialTokens,isNoTimestamps,isRealtime,nProcessors,splitOnWord,noFallback,diarize,speedUp,realtimeStream,initialPrompt,noContext,suppressNonSpeechTokens,keepModelLoaded,useGpu]);

@override
String toString() {
  return 'TranscribeRequest(audio: $audio, isTranslate: $isTranslate, threads: $threads, isVerbose: $isVerbose, language: $language, isSpecialTokens: $isSpecialTokens, isNoTimestamps: $isNoTimestamps, isRealtime: $isRealtime, nProcessors: $nProcessors, splitOnWord: $splitOnWord, noFallback: $noFallback, diarize: $diarize, speedUp: $speedUp, realtimeStream: $realtimeStream, initialPrompt: $initialPrompt, noContext: $noContext, suppressNonSpeechTokens: $suppressNonSpeechTokens, keepModelLoaded: $keepModelLoaded, useGpu: $useGpu)';
}
...
/// the next request reload the model rather than reuse a context parked
/// by [keepModelLoaded].
@override@JsonKey() final  bool useGpu;
