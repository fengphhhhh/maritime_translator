...
@JsonKey(name: 'from_ts', fromJson: WhisperTranscribeSegment._durationFromInt) Duration get fromTs;@JsonKey(name: 'to_ts', fromJson: WhisperTranscribeSegment._durationFromInt) Duration get toTs; String get text;/// `true` when tinydiarize detected a speaker change after this
/// segment. Only ever set when transcribing with `diarize: true` and
/// a `-tdrz` model (e.g. [WhisperModel.smallEnTdrz]).
@JsonKey(name: 'speaker_turn_next') bool get speakerTurnNext;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WhisperTranscribeSegment&&(identical(other.fromTs, fromTs) || other.fromTs == fromTs)&&(identical(other.toTs, toTs) || other.toTs == toTs)&&(identical(other.text, text) || other.text == text)&&(identical(other.speakerTurnNext, speakerTurnNext) || other.speakerTurnNext == speakerTurnNext));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,fromTs,toTs,text,speakerTurnNext);
...
@useResult
$Res call({
@JsonKey(name: 'from_ts', fromJson: WhisperTranscribeSegment._durationFromInt) Duration fromTs,@JsonKey(name: 'to_ts', fromJson: WhisperTranscribeSegment._durationFromInt) Duration toTs, String text,@JsonKey(name: 'speaker_turn_next') bool speakerTurnNext
});
...
/// Create a copy of WhisperTranscribeSegment
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? fromTs = null,Object? toTs = null,Object? text = null,Object? speakerTurnNext = null,}) {
...
as String,speakerTurnNext: null == speakerTurnNext ? _self.speakerTurnNext : speakerTurnNext // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'from_ts', fromJson: WhisperTranscribeSegment._durationFromInt)  Duration fromTs, @JsonKey(name: 'to_ts', fromJson: WhisperTranscribeSegment._durationFromInt)  Duration toTs,  String text, @JsonKey(name: 'speaker_turn_next')  bool speakerTurnNext)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WhisperTranscribeSegment() when $default != null:
return $default(_that.fromTs,_that.toTs,_that.text,_that.speakerTurnNext);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'from_ts', fromJson: WhisperTranscribeSegment._durationFromInt)  Duration fromTs, @JsonKey(name: 'to_ts', fromJson: WhisperTranscribeSegment._durationFromInt)  Duration toTs,  String text, @JsonKey(name: 'speaker_turn_next')  bool speakerTurnNext)  $default,) {final _that = this;
switch (_that) {
case _WhisperTranscribeSegment():
return $default(_that.fromTs,_that.toTs,_that.text,_that.speakerTurnNext);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'from_ts', fromJson: WhisperTranscribeSegment._durationFromInt)  Duration fromTs, @JsonKey(name: 'to_ts', fromJson: WhisperTranscribeSegment._durationFromInt)  Duration toTs,  String text, @JsonKey(name: 'speaker_turn_next')  bool speakerTurnNext)?  $default,) {final _that = this;
switch (_that) {
case _WhisperTranscribeSegment() when $default != null:
return $default(_that.fromTs,_that.toTs,_that.text,_that.speakerTurnNext);case _:
  return null;
...
class _WhisperTranscribeSegment implements WhisperTranscribeSegment {
  const _WhisperTranscribeSegment({@JsonKey(name: 'from_ts', fromJson: WhisperTranscribeSegment._durationFromInt) required this.fromTs, @JsonKey(name: 'to_ts', fromJson: WhisperTranscribeSegment._durationFromInt) required this.toTs, required this.text, @JsonKey(name: 'speaker_turn_next') this.speakerTurnNext = false});
...
/// segment. Only ever set when transcribing with `diarize: true` and
/// a `-tdrz` model (e.g. [WhisperModel.smallEnTdrz]).
@override@JsonKey(name: 'speaker_turn_next') final  bool speakerTurnNext;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WhisperTranscribeSegment&&(identical(other.fromTs, fromTs) || other.fromTs == fromTs)&&(identical(other.toTs, toTs) || other.toTs == toTs)&&(identical(other.text, text) || other.text == text)&&(identical(other.speakerTurnNext, speakerTurnNext) || other.speakerTurnNext == speakerTurnNext));
}
...
/// Create a copy of WhisperTranscribeSegment
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? fromTs = null,Object? toTs = null,Object? text = null,Object? speakerTurnNext = null,}) {
